...
namespace PSUMonitor.Serial
{
    ...
    public class SerialPortManager : IDisposable
    {
        ...
        public void StartListening()
        {
            ...
            _serialPort = new SerialPort(_currentSerialSettings.PortName, 115200, System.IO.Ports.Parity.None, 8, System.IO.Ports.StopBits.One);
